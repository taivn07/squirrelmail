...
<?php if (isset($js_web) && $js_web) {
  ...
  <input type="hidden" name="mailbox" value="<?php echo sq_htmlspecialchars($mailbox) ?>" />
  <input type="hidden" name="startMessage" value="<?php echo sq_htmlspecialchars($startMessage) ?>" />
   <?php
...
?>  <form method="post" action="<?php echo $form_action?>">
  ...
  <input type="hidden" name="mailbox" value="<?php echo sq_htmlspecialchars($mailbox) ?>" />
  <input type="hidden" name="spamcop_is_composing" value="<?php echo sq_htmlspecialchars($passed_id) ?>" />
  <input type="hidden" name="send_to" value="<?php echo sq_htmlspecialchars($report_email)?>" />
...
?>  <form method="post" action="http://members.spamcop.net/sc" name="submitspam"
  ...
  <input type="hidden" name="spam" value="<?php echo sq_htmlspecialchars($spam_message); ?>" />
<?php
