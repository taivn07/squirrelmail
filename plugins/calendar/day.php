            ...
            echo html_tag( 'tr', '', '', $color[$eo] ) .
                        ...
                        html_tag( 'td', '', 'left' ) . '[';
                            echo ($calbar['priority']==1) ? 
                                "<font color=\"$color[1]\">".sq_htmlspecialchars($calbar['title']).'</font>' : 
                                sq_htmlspecialchars($calbar['title']);
                            echo'] <div style="margin-left:10px">'.nl2br(sq_htmlspecialchars($calbar['message'])).'</div>' .
                        html_tag( 'td',
                            "<font size=\"-1\"><nobr>\n" .
