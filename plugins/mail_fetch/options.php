...
/* end globals */
    ...
    case 'config':
        ...
        if ($mailfetch_server_number>0) {
            ...
            for ($i=0;$i<$mailfetch_server_number;$i++) {
                echo "<option value=\"$i\">" .
                    sq_htmlspecialchars( (($mailfetch_alias_[$i]=='')?$mailfetch_server_[$i]:$mailfetch_alias_[$i])) . "</option>";
            }
            echo '</select>'.
            ...
            html_tag( 'table',
                ...
                html_tag( 'tr',
                    html_tag( 'td',
                        ...
                        '<br>' . _("Selected Server:") . " <b>" . sq_htmlspecialchars($mailfetch_server_[$mf_sn]) . "</b><br>" .
    ...
    case 'Modify':
        echo html_tag( 'table',
            ...
            html_tag( 'table' ) .
                html_tag( 'tr',
                    html_tag( 'th', _("Server:"), 'right' ) .
                    html_tag( 'td', '<input type="text" name="mf_server" value="' . sq_htmlspecialchars($mailfetch_server_[$mf_sn]) . '" size="40">', 'left' )
                ) .
                html_tag( 'tr',
                    html_tag( 'th', _("Port:"), 'right' ) .
                    html_tag( 'td', '<input type="text" name="mf_port" value="' . sq_htmlspecialchars($mailfetch_port_[$mf_sn]) . '" size="40">', 'left' )
                ) .
                html_tag( 'tr',
                    html_tag( 'th', _("Alias:"), 'right' ) .
                    html_tag( 'td', '<input type="text" name="mf_alias" value="' . sq_htmlspecialchars($mailfetch_alias_[$mf_sn]) . '" size="40">', 'left' )
                ) .
                html_tag( 'tr',
                    html_tag( 'th', _("Username:"), 'right' ) .
                    html_tag( 'td', '<input type="text" name="mf_user" value="' . sq_htmlspecialchars($mailfetch_user_[$mf_sn]) . '" size="20">', 'left' )
                ) .
                html_tag( 'tr',
                    html_tag( 'th', _("Password:"), 'right' ) .
                    html_tag( 'td', '<input type="password" name="mf_pass" value="' . sq_htmlspecialchars($mailfetch_pass_[$mf_sn]) . '" size="20">', 'left' )
                ) .
                html_tag( 'tr' ) .
                    html_tag( 'th', _("Store in Folder:"), 'right' ) .
                    html_tag( 'td', '', 'left' );
