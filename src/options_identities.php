...
function sti_input( $title, $name, $data, $bgcolor ) {
    ...
    $str .= '  <td> <input type="text" name="' . $name . '" size="50" value="'. sq_htmlspecialchars($data) . '"> </td>' . "\n";
    $str .= '</tr>';
...
function sti_textarea( $title, $name, $data, $bgcolor ) {
    ...
    $str .= '<tr' . $bgcolor . ">\n";
    $str .= '  <td style="white-space: nowrap;text-align:right;">' . $title . ' </td>' . "\n";
    $str .= '  <td> <textarea name="' . $name . '" cols="50" rows="5">'. sq_htmlspecialchars($data) . '</textarea> </td>' . "\n";
    $str .= '</tr>';
